...
export const TRACK_A_SOURCE_MANIFEST: readonly SourceManifestEntry[] = [
  ...
  },
  {
    ...
    source_year: 2026,
    document_version: null,
    reference: "Official source approved by frozen Track A specification; local copy pending",
    approval_status: "APPROVED",
    access_date: "2026-09-13",
    available_locally: false,
    local_reference: null,
  ...
  {
    source_id: "RAG-A03",
    title: "Anna University current B.E./B.Tech Curriculum & Syllabi catalogue",
    publisher: "Anna University",
    source_type: "OFFICIAL_CURRICULUM_CATALOGUE",
    source_year: null,
    document_version: null,
    reference: "https://cac.annauniv.edu/aidetails/ai_ug_cands_2025ft.html",
    approval_status: "APPROVED",
    access_date: "2026-09-13",
    available_locally: false,
    local_reference: null,
  ...
  {
    source_id: "RAG-A04",
    title: "Anna University University Departments current applicable curriculum",
    publisher: "Anna University",
