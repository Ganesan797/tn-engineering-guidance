...
See [Golden Product Mission](docs/product_mission.md), [Student Journey V1](docs/student_journey_v1.md), [Student Input & Output V1](docs/student_input_output_v1.md), [Technical Gap Mapping V1](docs/technical_gap_mapping_v1.md), and [Project Status](PROJECT_STATUS.md).
